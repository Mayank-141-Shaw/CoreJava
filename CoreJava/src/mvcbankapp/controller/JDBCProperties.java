...
//	final static String PROJECT_PATH = "D:\\Eclipse Projects\\Workspaces\\ServletTest\\";

	public static void loadProperties() {
		
		try {
			FileInputStream fis = new FileInputStream("res\\database.properties");
